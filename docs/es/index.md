...
Zettlr es software libre y abierto, lo que significa que el código está disponible públicamente, y la aplicación no tiene costo. Sin embargo, esto significa también que no hay un equipo pagado detrás de la aplicación – está completamente gestionada por la comunidad. Lo que implica que **te invitamos activamente a que quien lo use se involucre con la app**! Dependiendo de tus habilidades y qué te gusta más, hay varias formas en las que puedes ayudar en Zettlr:
...
- Puedes  [promover solicitudes abiertas en GitHub](https://github.com/Zettlr/Zettlr/issues) y ayudar a promover el desarrollo de la aplicación misma.
